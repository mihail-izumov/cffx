...
.brew-notification-content, .brew-notification-text, .brew-slide-up-enter-active, .brew-slide-up-leave-active, .brew-slide-up-enter-from, .brew-slide-up-leave-to {
  position: relative;
  height: 100%;
  display: flex;
  align-items: center;
