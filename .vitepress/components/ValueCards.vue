<template>
  <div class="brands-container">
    <div class="brand-card">
      ...
      <p class="description-main">Разберите бизнес-модели лидеров на атомы и заберите лучшие решения себе</p>
    </div>
    <div class="brand-card">
      <h3>Найти точки роста</h3>
      <p class="description-main">Превратите слабые места в источники силы, а жалобы клиентов — в дополнительную выручку</p>
    </div>
    <div class="brand-card">
      <h3>Проверить на любом рынке</h3>
      <p class="description-main">Узнайте, как ваша кофейня поведет себя в Самаре, Москве или на Луне</p>
    </div>
    <div class="brand-card">
      <h3>Получить поддержку Анны</h3>
      <p class="description-main">Помощь ИИ-ассистента Анны через персональный чат в Telegram</p>
    </div>
  </div>
</template>
<style scoped>
