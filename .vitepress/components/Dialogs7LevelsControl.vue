...
<template>
  <div class="feature-selector-container" :style="{ minHeight: containerHeight + 'px' }">
    ...
    <div class="content-wrapper">
      ...
      <!-- Правая часть: фиксированное изображение чашки -->
...
/* Стрелки — центрированы по вертикали */
.nav-placeholder {
  width: 52px;
  flex-shrink: 0;
  display: flex;
...
/* Фиксированное изображение чашки — справа, не двигается */
.image-placeholder {
  flex: 1;
  min-height: 100%;
...
/* Мобильная версия — изображение скрывается */
@media (max-width: 768px) {
  .image-placeholder {
    display: none;
  }
