...
const cards = [
  ...
  {
    title: '2. 3 дня: Тест-драйв системы',
    description: 'Выделите команду запуска, чтобы протестировать ваши Сигналы, например, работу виджета, ответы Анны и тикеты для команды.',
    imgSrc: '/123-ban-delivery.svg',
    imgAlt: 'Тест-драйв системы'
  },
  {
    title: '3. Позже: Уточнить настройки',
    ...
    imgSrc: '/123-ban-customize',
    imgAlt: 'Уточнить настройки'
  }
];

// Формируем автоматическую подстановку названия месяца для первой карточки
const descriptionWithMonth = `Стартуйте сейчас ₽50,000 (полностью возмещаемый), настройте потом – первые Сигналы в ${nowMonth}. Мы сообщим, когда придет время для теста.`;
</script>
