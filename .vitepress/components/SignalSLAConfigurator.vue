...
<style scoped>
.signal-sla.dark{--bg:transparent;--card:#151719;--muted:#9aa3ad;--text:#e8eaed;--line:#2a2d31;--green:#4ade80;--green-10:rgba(77,222,128,0.05);--lime:#c5f946;background:var(--bg);color:var(--text);padding-bottom:20px;font-size:13px;max-width:980px;margin:0 auto;overflow-wrap:anywhere}
h2,h3,h4{margin:0 0 6px}h2{font-size:22px}h3{font-size:15px}h4{font-size:13px}
.card{background:var(--card);border:1px solid var(--line);border-radius:12px;padding:14px 12px;margin:10px 0}
...
input[type="text"],input[type="number"],input[type="time"],select{padding:7px 9px;border-radius:10px;background:#0b0c0e;color:var(--text);border:1px solid var(--line);font-size:12px;flex:1}
.time-white{color:#fff !important}
.select-wrapper{position:relative;flex:1;display:flex;align-items:center}
.select-arrow{appearance:none;width:100%;padding:7px 28px 7px 9px !important;background:#0b0c0e;padding-right:28px !important;cursor:pointer}
.chevron-icon{position:absolute;right:8px;pointer-events:none;color:#999;flex-shrink:0}
.company.big{font-size:16px}.fullwidth{width:100%}
...
.inline-value{color:#fff;font-size:12px;min-width:40px;text-align:right}
.widget-row{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:12px}
.widget-card{border:1px solid var(--line);border-radius:12px;padding:10px;background:#0d0f12;text-align:left;cursor:pointer;display:flex;align-items:center;gap:10px;font-size:13px}
.widget-card.active{border-color:var(--lime);background:#1a1d20}
.widget-icon{width:48px;height:48px;object-fit:contain;flex-shrink:0}
.w-title{font-weight:700}
.company-fields{display:grid;grid-template-columns:1fr;gap:8px}
.retention-block{display:grid;gap:3px}
.ltv-block{margin-top:6px}
.ltv-title{font-weight:600;margin-bottom:5px;font-size:12px}
.ltv-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:8px}
.ltv-card{border:1px solid var(--line);border-radius:12px;padding:8px 10px;background:#0d0f12;text-align:left;cursor:pointer;font-size:12px}
.ltv-card.active{border-color:var(--lime);background:#1a1d20}
.ltv-other{margin-top:8px;font-size:12px}
...
.linklike.same{font-size:12px}
.linklike-calc{background:transparent;border:none;color:var(--lime);text-decoration:none;cursor:pointer;padding:0;font-size:12px;display:inline-flex;align-items:center;gap:4px;margin-top:6px}
.linklike-calc:hover{text-decoration:underline}
.ext-icon{width:12px;height:12px}
.hint{color:var(--muted);font-size:11px}.divider{height:1px;background:var(--line);margin:8px 0}
.goal-title{font-weight:700;color:#fff;font-size:13px;margin-bottom:1px}
.goal-line{font-size:12px;color:#c0c0c0}
.goals-row{display:flex;align-items:center;justify-content:space-between;padding:8px 0;border-top:1px solid var(--line)}
.goals-row:first-of-type{border-top:none}
.nps-cards{display:flex;gap:6px;flex-wrap:wrap}
.nps-card{border:1px solid var(--line);border-radius:12px;padding:8px 12px;background:#0d0f12;color:#e8eaed;cursor:pointer;flex:1;min-width:70px;text-align:center;font-size:12px}
.nps-card.active{border-color:var(--lime);background:#1a1d20}
.mini-ag{display:flex;gap:6px;flex-wrap:wrap}
.mini-badge{background:#0b0c0e;border:1px solid var(--line);border-radius:12px;padding:6px 8px;font-size:11px}
.mini-sub{color:#9aa3ad;font-size:10px;margin-top:2px}
.field-label{color:#fff;font-weight:700;font-size:12px}
.lime{color:var(--lime)}
.lime-outline{border-color:var(--lime)!important;background:var(--green-10)}
.sla-title{margin:0 0 4px;border-bottom:none !important}.price{margin:0;color:#fff;font-size:20px}.price-note{color:#c0c0c0;font-size:12px;margin-bottom:12px}
.sla-cards{display:grid;gap:10px;margin-top:10px}
.sla-card{background:rgba(12,12,14,0.7);border:1px solid var(--line);border-radius:12px;padding:12px;font-size:13px}
.sla-card.dashed{border:2px dashed var(--lime);background:transparent}
.sla-card-title{font-size:14px;font-weight:700;margin:0 0 4px}
.sla-card-desc{font-size:11px;color:rgba(255,255,255,0.7);line-height:1.3}
.sla-card-calc{font-size:12px;color:#fff;margin-bottom:4px;font-weight:600}
.sla-subgroup{display:flex;justify-content:space-between;align-items:center;margin-top:6px;padding-top:6px;border-top:1px solid var(--line)}
.sla-subgroup-title{font-weight:600;font-size:12px}
.contact-in-summary{background:rgba(12,12,14,0.7);border:1px solid var(--line);margin:12px 0 10px}
.contact-grid{display:grid;grid-template-columns:1fr 1fr;gap:8px}
.terms-row{display:flex;align-items:flex-start;gap:6px;margin-bottom:10px;font-size:12px}
...
.submit-message{padding:10px 12px;border-radius:12px;margin-bottom:10px;font-size:12px;font-weight:600;text-align:center;animation:slideDown 0.3s ease}
...
button.primary{padding:12px 14px;border-radius:12px;border:none;cursor:pointer;display:flex;align-items:center;justify-content:flex-start;gap:10px;font-size:13px}
...
.cta-row{display:grid;grid-template-columns:1fr;gap:6px;margin-top:8px}
...
.pricing-modal-header{font-size:0.9rem;color:#6e6e73;margin:50px 70px 10px 70px;font-weight:500;letter-spacing:0.08em}
.pricing-modal-title{font-size:2rem;font-weight:600;color:#1d1d1f;margin:0 70px 20px 70px}
.pricing-modal-body{padding:0 70px 50px;overflow-y:auto;max-height:calc(90vh - 200px)}
.surface{background:#edeef0;border-radius:12px;padding:7px 9px}
.pad{padding:12px 10px}.black{color:#1d1d1f!important}
.owner-col-single{display:grid;gap:16px}
.owner-block{padding:14px}
.cat-h2,.section-h2{font-size:16px;font-weight:600;color:#1d1d1f;margin:0 0 9px 0}
.topics-grid.compact3{display:grid;grid-template-columns:repeat(3,1fr);gap:6px;margin-top:10px}
.topic-card{display:flex;align-items:center;gap:6px;padding:6px;border:1px solid #d2d3d6;border-radius:10px;background:#f1f2f4;cursor:pointer;font-size:11px}
.topic-card.small{padding:5px 6px}
.topic-card.selected{border-color:var(--lime);background:#e7f7ee}
.topic-card:disabled{opacity:0.4;cursor:not-allowed}
.topic-card input[type="checkbox"]{accent-color:var(--green);width:14px;height:14px;pointer-events:none}
.extras-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:8px}
.extra-card{border:1px solid #d2d3d6;border-radius:10px;padding:8px;background:#f1f2f4;color:#1d1d1f;cursor:pointer;text-align:center;font-size:12px}
.extra-card.active{border-color:var(--lime);background:#dcfce7}
.spaced-large{display:grid;grid-template-columns:1fr;gap:14px}
.radio-left .row,.radio-left{display:flex;align-items:center;gap:10px}
.radio-left input[type="radio"],.radio-big{accent-color:var(--lime);width:16px;height:16px;border-radius:50%}
.checks-grid-2col{display:grid;grid-template-columns:1fr 1fr;gap:6px;margin-top:6px}
.checks-grid-2col input[type="checkbox"]{accent-color:var(--lime)}
.sla-detail-cards{display:grid;gap:8px}
.sla-detail-card{background:#edeef0;border-radius:10px;padding:10px;color:#1d1d1f;font-size:12px;line-height:1.4;display:flex;align-items:flex-start;gap:8px}
.detail-check{flex-shrink:0;margin-top:1px}
...
@media(max-width:1024px){
  ...
  button.primary{padding:11px 12px;font-size:12px;gap:8px}
  .card{padding:12px 10px;margin:8px 0}
  .sla-cards{gap:8px;margin-top:8px}
}
</style>
