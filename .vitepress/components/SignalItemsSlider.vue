...
const signalItems = [
  ...
  },
  {
    ...
    url: '/signals',
    // Исправлено: все элементы (звезда, плюс, круг) объединены в один <path>
    // M20 2v4 -> вертикальная линия плюса
    // M22 4h-4 -> горизонтальная линия плюса
    // M4 18... -> круг преобразован в кривые
