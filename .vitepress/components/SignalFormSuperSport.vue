...
const baseSuggestions = {
  female: {
    emotions: {
      ...
      'запомнили имя': ['обращаются по имени при входе','поздравляют с днём рождения','отмечают прогресс в сообщениях','учёт ваших успехов ведёт тренер','индивидуальная рассылка уведомлений'],
  ...
  male: {
    emotions: {
      ...
      'появлением нового оборудования': ['не видел такого раньше','удобное положение','больше выбор','ещё тише в зале','впечатляет эргономика'],
      ...
      'не оправдал ожидания': ['слабая программа','нет обещанного результата','часть оборудования занята','скучно','отсутствует обратная связь'],
  ...
  facts: {
    ...
    'списали через приложение и картой': ['две разные суммы','прошёл платёж дважды','ответили только в чате','разбирался сам','попросили номер карты для возврата'],
  ...
  solutions: {
    ...
    'компенсация': ['продление абонемента','бонусные баллы','скидка на сервис','повышение тарифа'],
