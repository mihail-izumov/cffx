...
const baseSuggestions = {
  ...
  common: {
    wishes: {
      // LEVEL 2 -> LEVEL 3 (СВЯЗКИ И ФИНАЛЫ)
      ...
      // ЖЕНСКИЙ ЮМОР (Morning Zombie & Guilty Pleasure)
