...
// === ПОДСКАЗКИ ===
// ПОЛНАЯ 3-УРОВНЕВАЯ система подсказок (Corrected & Viral Version)
const baseSuggestions = {
  female: {
    emotions: {
      ...
      'мой муд': ['зимняя сказка', 'шальная императрица', 'жду чудо', 'нужен дофамин', 'хочу на ручки'],
  ...
  common: {
    emotions: {
      // === ПОЗДРАВЛЯЮ (Кого? Винительный падеж) ===
      ...
      // === ЖЕЛАЮ (Кому? Дательный падеж) ===
      'себе': ['лёгкости', 'денег', 'любви', 'вдохновения', 'терпения'],
      ...
      'жду чудо': ['новогоднее', 'прямо сейчас', 'и кофе', 'в каждом глотке'],
