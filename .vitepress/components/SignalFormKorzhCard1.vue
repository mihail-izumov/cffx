...
// === ПОДСКАЗКИ ===
// ПОЛНАЯ 3-УРОВНЕВАЯ система подсказок (Final Masculine Check)
const baseSuggestions = {
  female: {
    emotions: {
      ...
      'желаю': ['себе', 'любимой кофейне', 'команде', 'лёгкости', 'чуда'],
      'шлю': ['лучи добра', 'сердечко', 'обнимашки', 'сигнал в космос', 'вайб успеха'],
      'мой муд': ['зимняя сказка', 'шальная императрица', 'режим ожидания', 'нужен дофамин', 'хочу на ручки'],
  ...
  male: {
    emotions: {
      ...
      'шлю': ['респект', 'салют', 'сигнал в космос', 'вайб успеха', 'благодарность'], // Убрали "лучи добра" (мягко)
      'мой муд': ['зимняя спячка', 'волк с уолл-стрит', 'тотальный дзен', 'режим терминатора', 'победитель'],
      'официально заявляю': ['мой допинг', 'этот кофе', 'мой девиз', 'дедлайны горят', 'у меня растущий организм'], // Заменили "Вместо психолога"
      'признаюсь': ['виню пробки', 'съел два десерта', 'спасся кофеином', 'это шедевр', 'не хочу работать'] // Заменили "Меркурий" на "Пробки"
    }
  },
  common: {
    emotions: {
      ...
      'сигнал в космос': ['все будет супер', 'я здесь', 'прием', 'запрос отправлен'],
      ...
      // === МОЙ МУД (Существительное или состояние) ===
      ...
      'режим ожидания': ['чуда', 'нового года', 'зарплаты', 'выключен'],
      'нужен дофамин': ['срочно', 'в виде десерта', 'много', 'вкусный'],
      ...
      'этот кофе': ['лучше, чем бывший', 'моя новая любовь', 'лучше, чем сон', 'топливо для ракеты', 'решает вопросы'],
      ...
      'не хочу работать': ['хочу кофе', 'хочу в отпуск', 'сегодня выходной', 'ищу вдохновение', 'ушел в оффлайн']
    }
  }
}
