...
const baseSuggestions = {
  ...
  // Гендерно-нейтральные подсказки (общие продолжения для всех)
  common: {
    emotions: {
      // LEVEL 3 (DETAILS & ENDINGS)
      
      // СВЯЗКИ: КОМУ/ЧЕМУ (Level 2 -> Level 3)
      ...
      // СВЯЗКИ: ЮМОР ЖЕНСКИЙ (Level 2 -> Level 3)
      ...
      // СВЯЗКИ: ЮМОР МУЖСКОЙ (Level 2 -> Level 3)
      ...
      // СВЯЗКИ: УНИВЕРСАЛЬНЫЕ (Level 2 -> Level 3)
      ...
      'с Новым годом': ['и Рождеством!', 'пусть сбудется!', 'Ура!', 'счастья вам!', 'новым счастьем!'],
      'вы супер': ['люблю вас!', 'лучшие в городе!', 'молодцы!', 'команда мечты!', 'спасибо!']
    }
  }
};
