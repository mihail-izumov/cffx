    ...
    <div class="cards-grid">
      ...
      <div class="glow-card">
        <div class="card-content">
          ...
          <p class="card-text">
            Количество инвесторов в новые кофейни ограничено. Чем позже заявка – тем ниже приоритет. Ранний доступ гарантирует ваше место в списке, чтобы инвестировать раньше других.
          </p>
        </div>
      </div>
      ...
      <div class="glow-card">
        <div class="card-content">
          ...
          <h3 class="card-title">Будьте в курсе событий</h3>
          <p class="card-text">
            Получайте регулярные обновления о возможностях инвестировать в новые кофейни "Корж" напрямую от Сигнала. До начала их раунда инвестиций — чтобы принять решение как можно раньше.
          </p>
        </div>
      </div>
