  ...
  <div class="early-access-widget">
    ...
    <div class="header-section">
      ...
      <p class="widget-subtitle">
        Корж скоро откроет возможность инвестировать в новые кофейни. <br>С Ранним Доступом вы фиксируете свой приоритет в списке и получаете регулярные обновления. 
      </p>
    </div>
