<template>
  <div class="early-access-widget">
    ...
    <div class="header-section">
      <h2 class="widget-title">Зачем отправлять зявку</h2>
      <p class="widget-subtitle">
        Корж скоро откроет возможность инвестировать в новые кофейни. <br>С заявкой вы фиксируете свой приоритет в списке и получаете регулярные обновления. 
      </p>
    </div>
    ...
    <div class="cards-grid">
        ...
        <div class="card-content">
          <div class="icon-wrapper">
            <svg
              ...
              viewBox="0 0 24 24"
              fill="none"
              stroke="url(#icon-gradient-purple-fixed)"
              stroke-width="2"
          ...
          <p class="card-text">
            Количество инвесторов ограничено. Чем позже заявка – тем ниже приоритет. Ранний доступ гарантирует ваше место в списке, чтобы инвестировать раньше других.
          </p>
        </div>
      </div>
      ...
      <div class="glow-card">
        <div class="card-content">
          ...
          <h3 class="card-title">В курсе событий</h3>
          <p class="card-text">
            Получайте регулярные обновления о возможностях инвестировать в новые кофейни "Корж" напрямую от Сигнала. Актуальная информация персонально в Телеграм.
          </p>
        </div>
      </div>
