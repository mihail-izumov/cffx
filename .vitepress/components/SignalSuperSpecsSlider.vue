  ...
  <div class="sss-slider-wrapper">
    <div class="sss-brands-container" ref="sliderContainer">
      ...
      >
        ...
        <!-- Акцентная выгода (лайм) -->
        <div class="sss-main-benefit">{{ slide.benefit }}</div>
        <!-- Блок "Ваш контроль" -->
        <div class="sss-control-area">
          <span class="sss-control-label">Ваш контроль:</span>
          <span class="sss-control-multiline">
            <span class="sss-control-highlight" v-for="(line, i) in slide.control" :key="i">{{ line }}</span>
          </span>
        </div>
        <!-- Подробности -->
...
// Каждая строка блока "Ваш контроль" отдельной строкой для маркера и переноса
const slides = [
  {
    ...
    control: [
      ...
      'в приложении или в любом формате для сферы услуг.'
    ],
  ...
  },
  {
    ...
    control: [
      'Настраиваем форму под специфику бизнеса —',
      'структуру Сигналов, формулировки, точки напряжения.'
    ],
  ...
  },
  {
    ...
    control: [
      'Видите статус, сроки, причину проблемы и итог —',
      'система концентрируется на пользу для гостя.'
    ],
  ...
  },
  {
    ...
    control: [
      'Оператор работает по правилам',
      'и срокам вашего бизнеса.'
    ],
  ...
  },
  {
    ...
    control: [
      'Управляете сценариями и стандартами Анны —',
      'она действует строго в рамках ваших правил.'
    ],
  ...
  },
  {
    ...
    control: [
      ...
      'обучение команды, настройка под специфику бизнеса.'
    ],
  ...
  },
  {
    ...
    control: [
      'Получаете готовые управленческие отчёты с фактами —',
      'видите причины проблем, рост качества, зоны для развития.'
    ],
  ...
  },
  {
    ...
    control: [
      'Прозрачный процесс на основе',
      'данных и вашей обратной связи.'
    ],
...
<style scoped>
.sss-slider-wrapper { position: relative; margin: 24px 0; background: #232323; }
...
.sss-brand-card {
  ...
  transition: border-top-color 0.4s cubic-bezier(0.4,0,0.2,1), box-shadow 0.3s;
  background-color: #232323;
  border-color: #333; border-top-color: rgba(197,249,70,0.28);
  outline: none; cursor: pointer;
}
.sss-brand-card.active {
  border-top-color: #C5F946;
  box-shadow: 0 0 24px 0 rgba(197,249,70,0.15);
}
.sss-card-background-icon {
  position: absolute; bottom: -90px; right: -90px; width: 300px; height: 300px;
  opacity: 0.045; pointer-events: none; z-index: 0;
}
.sss-card-background-icon svg { width: 100%; height: 100%; stroke: currentColor; }
.sss-step-card .sss-card-background-icon { color: #fff; }

.sss-title { font-size: 16px; font-weight: 700; color: #fff; margin-bottom: 0; }
.sss-main-benefit { color: #C5F946; font-size: 16px; font-weight: 500; margin-bottom: 0; margin-top: 0; }
.sss-control-area { display: flex; align-items: flex-start; gap: 12px; margin-bottom: 0; margin-top: 0; }
.sss-control-label { color: #fff; font-weight: 700; font-size: 17px; margin-right: 2px; min-width: 110px; line-height: 1.4;}
.sss-control-multiline { display: flex; flex-direction: column; gap: 3px;}
...
.sss-description-details { color: #b0b0b0; font-size: 13px; line-height: 1.62; margin-top: auto; margin-bottom: 9px;}
.sss-more-link-area { margin-bottom: 2px; margin-top: 8px; display: flex; justify-content: flex-start;}
.sss-more-link { font-size: 15px; color: #b0b0b0; font-weight: 500; border: none; outline: none; background: none; cursor: pointer; text-decoration: none; display: flex; align-items: center; gap: 6px; transition: color 0.3s;}
.sss-more-link.active { color: #C5F946; }
.sss-arrow { font-size: 19px; transition: transform 0.25s; margin-left: 2px;}
.sss-arrow.move { transform: translateX(9px);}
...
.sss-nav-next { background-color: #fff; color: #232323;}
