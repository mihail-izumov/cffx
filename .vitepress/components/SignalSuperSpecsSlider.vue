    ...
    <div class="sss-brands-container" ref="sliderContainer">
      ...
      >
        <div class="sss-card-background-icon">
          <span class="sss-bgsvg" v-html="slide.icon"></span>
        </div>
...
// SVG строки для фона каждого слайда (можно заменить на data:image/svg+xml;base64,...)
const icons = [
...
`<svg xmlns="http://www.w3.org/2000/svg" width="300" height="300" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="14" x="3" y="5" rx="2" ry="2"/><path d="M7 15h4"/><path d="M15 15h2"/><path d="M7 11h2"/><path d="M13 11h4"/></svg>`,
...
<style scoped>
/* стили — прежние, см. предыдущие ответы */
</style>
