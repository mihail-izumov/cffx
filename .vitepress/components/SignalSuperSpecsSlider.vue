<template>
  <div class="sss-slider-wrapper">
    <div class="sss-brands-container" ref="sliderContainer">
      ...
      >
        <!-- SVG внутри карточки -->
        <div class="sss-card-background-icon" v-html="slide.iconSvg"></div>
...
// SVG строки (графитовый цвет)
const iconsSvg = [
  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#232323" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
.sss-brand-card {
  ...
  overflow: hidden !important; /* НЕ ВЫХОДИТ ЗА ПРЕДЕЛЫ */
