...
const slides = [
  {
    link: '/pro/dialogs',
    headline: 'Виджет',
    benefit: 'Обратная связь за пару кликов. Гость сообщает о проблеме, а вы получаете все обращения точно и вовремя.',
  ...
  },
  {
    ...
    details: 'Ведёт индивидуальный диалог с клиентом. Задаёт уточняющие вопросы, разбирается в эмоциях, предлагает решение и сопровождает до результата — без шаблонов и формальных ответов. Персональный подход к каждому клиенту и к каждой ситуации.',
    paths: [
  ...
  },
  {
    ...
    details: 'Все элементы системы — виджет, Анна, тикет-система — постоянно обновляются на основе непрерывной аналитики. Команда Сигнала следит за процессами и результатами, слушает вашу команду и гостей, суммирует опыт и оперативно вносит улучшения.',
    paths: [
