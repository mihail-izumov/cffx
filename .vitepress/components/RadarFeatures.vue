...
<div class="signal-product-tabs__nav">
  ...
  <button :class="{ active: activeTab === 'basic_analytics' }" @click="activeTab = 'basic_analytics'">
    💡 Аналитика (базовая)
  </button>
  <button :class="{ active: activeTab === 'advanced_analytics' }" @click="activeTab = 'advanced_analytics'">
