<template>
  <div class="signal-badge">
    ...
    <div class="badge-text">
      ...
      <span class="badge-brand">Signal</span>
    </div>
  </div>
</template>
...
/* Задержка для каждой волны (создаёт эффект постоянного сканирования) */
.wave-1 {
  animation-delay: 0s;
}
...
/* Анимация: волна расширяется от центра и растворяется */
