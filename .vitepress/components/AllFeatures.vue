<template>
  <div class="brands-container">
    ...
    <div class="brand-card radar-card">
      ...
      <h3>Голос клиента</h3>
      <p class="description-main">Очищенная база отзывов показывает истинное мнение гостей о вас и конкурентах</p>
      <p class="description-goals">Превращает хаос мнений в четкую карту действий</p>
    </div>
    
    <div class="brand-card radar-card">
      <div class="tariff-badge radar">Радар</div>
      <h3>Реальная карта конкурентов</h3>
      <p class="description-main">Точно понимаете, с кем вас сравнивают гости при выборе сегодня</p>
      <p class="description-goals">Объективное позиционирование: от атмосферы и сервиса до скорости и качества</p>
    </div>
    
    <div class="brand-card radar-card">
      <div class="tariff-badge radar">Радар</div>
      <h3>Ежемесячная диагностика</h3>
      <p class="description-main">Выделяем именно те 10 факторов, которые влияют на решение прийти к вам или к конкуренту</p>
      <p class="description-goals">О чем конкретно говорят: 10 критериев с примерами</p>
    </div>
    
    <div class="brand-card radar-card">
      <div class="tariff-badge radar">Радар</div>
      <h3>Честные оценки</h3>
      <p class="description-main">Отчет: где вы лидируете, где отстаете, и что нужно исправить в первую очередь</p>
      <p class="description-goals">1 до 10 по каждому из 10 критериев</p>
    </div>
    
    <div class="brand-card radar-card">
      <div class="tariff-badge radar">Радар</div>
      <h3>Персональные сессии</h3>
      <p class="description-main">Отслеживайте прогресс на стратегических сессиях с аналитиком Сигнала</p>
    ...
    <div class="brand-card radar-card">
      <div class="tariff-badge radar">Радар</div>
      <h3>Темный Режим</h3>
      <p class="description-main">Скрытые срезы: паттерны и тренды, невидимые для рынка в контексте вашей кофейни</p>
      <p class="description-goals">Находите то, что упускают 90% игроков</p>
    </div>
    
    <div class="brand-card radar-card">
      <div class="tariff-badge radar">Радар</div>
      <h3>Сигналы изменений</h3>
...
.dark .radar-card .description-goals {
...
.dark .tariff-badge.radar {
  background-color: rgba(169, 142, 96, 0.3);
  color: #c4a76b;
}
</style>
...
.vp-doc .brands-container .radar-card,
.vp-content .brands-container .radar-card {
  background-color: #f9f8f6 !important;
  border-color: #e5e2dd !important;
...
.dark .vp-doc .brands-container .radar-card,
.dark .vp-content .brands-container .radar-card {
  background-color: #2B2A27 !important;
  border-color: #383633 !important;
  border-top: 4px solid #A98E60 !important;
}
...
.dark .brands-container .radar-card {
  background-color: #2B2A27 !important;
}
</style>
