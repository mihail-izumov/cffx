...
Этот запрос — ваш следующий шаг на пути к системному росту. Убедитесь, что вы знакомы с основными принципами нашего подхода: <br><br>
...
> Анна сообщит вам статус в Telegram
2. **Потенциал >75%** → Приглашение на 90-мин. стартовую сессию (₽35000)
3. **После сессии** → Финальное решение с развернутой обратной связью (24 ч)
4. **Условия выполнены** → Старт Чекапа (48 ч)

> **Рассматриваем запросы и определяем сроки самостоятельно, исходя из текущей загрузки и приоритетов.**
> Ведем не более 12 проектов в год, чтобы гарантировать максимальную глубину анализа. Приоритет получают компании, чей потенциал и готовность к изменениям наиболее очевидны по результатам анализа Радара. Это позволяет концентрировать энергию на самых перспективных партнерствах.
...
> **Честная оценка готовности к изменениям:** 70% обратившихся компаний не проходят Чекап.
...
## Важное уточнение для вашего запроса
