<div class="brew-specs-container">
  ...
  <div class="specs-section">
    ...
    <div class="specs-grid four-cols">
      <div class="spec-item">
        <span class="spec-value">2,415</span>
        <p class="spec-label">Очищенных отзывов (на примере Самары)</p>
      </div>
      <div class="spec-item">
        <span class="spec-value">20+</span>
        <p class="spec-label">Готовых диалоговых сценариев</p>
      </div>
      <div class="spec-item">
...
<style>
  .brew-specs-container {
    ...
    color: #fff;
    padding: 64px 24px;
    max-width: 1128px; /* Ширина контента как у Tesla */
    margin: 0 auto;
  }
  .specs-section {
    margin-bottom: 56px;
  ...
  .section-title {
    font-size: 28px; /* Размер как у "Dimensions" */
    font-weight: 500;
    color: #fff;
    margin: 0 0 24px 0;
    padding: 0;
  ...
  .specs-grid {
    display: grid;
    gap: 32px;
    padding-left: 0; /* Убираем отступ слева для грида */
  }
  ...
  .spec-item .spec-label {
    ...
    color: #5c5e62; /* Серый цвет как у Tesla */
    line-height: 1.4;
    margin: 0;
    padding: 0;
  }
  .spec-item .spec-value {
    ...
    color: #fff;
    line-height: 1.4;
    margin-bottom: 4px; /* Отступ между значением и лейблом */
  }
