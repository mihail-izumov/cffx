# 123
ё<!-- HTML-структура карточек (остается без изменений) -->
...
.feature-card {
  /* Изменено: фон стал более контрастным */
  background: rgba(240, 240, 245, 0.9);
  /* Изменено: убрана обводка */
  border: none;
  border-radius: 12px;
  padding: 28px 24px;
...
/* Убрано свечение обводки при наведении */
.feature-card:hover {
...
.feature-card p {
  /* Изменено: цвет стал более приглушенным (менее контрастным) */
  color: var(--vp-c-text-2); 
  /* Изменено: шрифт стал меньше, чем у заголовка */
