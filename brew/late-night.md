...
/* 
  ...
  Используем переменные VitePress для автоматической смены темы
*/
.feature-card {
  /* 
    var(--vp-c-bg-soft) — это стандартный цвет фона для таких элементов.
    Он будет светло-серым на светлой теме и тёмно-серым на тёмной.
  */
  background-color: var(--vp-c-bg-soft);
  /* 
    Добавляем рамку, цвет которой также меняется с темой, 
    чтобы карточка не сливалась с фоном.
  */
  ...
  height: 100%;
  /* 
    Блок для тёмной темы (:root.dark .feature-card) больше не нужен,
    так как переменные делают всю работу за нас.
  */
}
...
.feature-card p {
  /* Эта переменная уже используется и отлично подходит, т.к. тоже адаптивна */
