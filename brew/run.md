...
<div class="start-button-container">
  <a href="/brew/membership" class="btn btn-primary" rel="noopener noreferrer">Умная Кофейня →</a>
</div>
...
## B-R-E-W — новый способ строить и масштабировать кофейный бизнес
...
Объективные данные о лидерах рынка, чтобы **побеждать, играя по своим правилам**.
