...
| до B-R-E-W | вместе с B-R-E-W |
| :--- | :--- |
| Нечеткое понимание проблем и возможностей | **→ Точки роста** с приоритетами  |
| Отсутствие системного плана развития | **→ Точный план** улучшений |
| Ручной и хаотичный контроль процессов | ** →Непрерывный мониторинг** ключевых процессов |
| Недостаточная вовлеченность команды | **→ Конкретные метрики** роста вовлеченности |
