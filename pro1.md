...
<div style="border-top: 1px solid rgba(255, 255, 255, 0.15); margin: 40px 0;"></div>
...
<p>
<strong>Каждый Сигнал = возможность вернуть клиента сегодня. </strong>Приносит стабильный рост за счет экстра-удержания клиентов. Окупается сразу.
</p>
