...
| **Усилить преимущество** | Модели успеха лидеров рынка | Маркетологам, бренд-менеджерам |
| **Изучить конкурентов** | Сравнительные таблицы и позиционирование | Аналитикам, стратегам |
| **Найти возможности роста** | 10 точек роста | Инвесторам, развитию |
...
|---|---|---|
|**[Как увеличить скорость в 2 раза](https://www.perplexity.ai/search/vystupi-v-roli-konsultanta-po-DWXYrOxdTxChS3Akfde6_g#10)**|**Скорость обслуживания**|31% жалоб = прямая потеря выручки|
|**[Как стандартизировать качество](https://www.perplexity.ai/search/vystupi-v-roli-konsultanta-po-DWXYrOxdTxChS3Akfde6_g#11)**|**Нестабильность кофе**|18% критики подрывает доверие к бренду|
|**[Как найти правильную цену](https://www.perplexity.ai/search/vystupi-v-roli-konsultanta-po-DWXYrOxdTxChS3Akfde6_g#12)**|**Ценовая дилемма**|37% считают «дорого» — риск оттока массового сегмента|
...
|---|---|---|---|
|**[Как масштабировать уют](https://www.perplexity.ai/search/vystupi-v-roli-konsultanta-po-DWXYrOxdTxChS3Akfde6_g#13)**|**«Корж»**|Эмоциональная связь (9/10)|«Домашняя» атмосфера + персональный сервис|
|**[Как построить систему](https://www.perplexity.ai/search/vystupi-v-roli-konsultanta-po-DWXYrOxdTxChS3Akfde6_g#14)**|**Skuratov**|Системность (9/10 кофе)|Стандартизация процессов + стабильность|
|**[Как создать культ бренда](https://www.perplexity.ai/search/vystupi-v-roli-konsultanta-po-DWXYrOxdTxChS3Akfde6_g#15)**|**Surf Coffee**|Нишевый брендинг (9/10 дизайн)|«Племя» молодежи + субкультурная эстетика|
|**[Как монетизировать локацию](https://www.perplexity.ai/search/vystupi-v-roli-konsultanta-po-DWXYrOxdTxChS3Akfde6_g#16)**|**White Cup**|Уникальность места (9/10 атмосфера)|«Дворик как в Европе» + destination place|
|**[Как доминировать по цене](https://www.perplexity.ai/search/vystupi-v-roli-konsultanta-po-DWXYrOxdTxChS3Akfde6_g#17)**|**Coffee Balance**|Ценовое позиционирование (8/10 цена/качество)|«Доступное качество» + массовый сегмент|
...
|---|---|---|---|---|
|**[Сравнить качество](https://www.perplexity.ai/search/vystupi-v-roli-konsultanta-po-DWXYrOxdTxChS3Akfde6_g#18)**|Качество кофе|Skuratov (9)|Корж, Surf, White Cup (8)|Coffee Balance (6)|
|**[Сравнить атмосферу](https://www.perplexity.ai/search/vystupi-v-roli-konsultanta-po-DWXYrOxdTxChS3Akfde6_g#19)**|Атмосфера|Корж, Surf, White Cup (9)|Skuratov (8)|Coffee Balance (7)|
|**[Сравнить сервис](https://www.perplexity.ai/search/vystupi-v-roli-konsultanta-po-DWXYrOxdTxChS3Akfde6_g#20)**|Сервис|**Корж (9)**|Skuratov, White Cup (8)|Surf, Coffee Balance (7)|
|**[Сравнить скорость](https://www.perplexity.ai/search/vystupi-v-roli-konsultanta-po-DWXYrOxdTxChS3Akfde6_g#21)**|Скорость|Skuratov, White Cup (8)|Корж, Surf (7)|Coffee Balance (6)|
|**[Сравнить выпечку](https://www.perplexity.ai/search/vystupi-v-roli-konsultanta-po-DWXYrOxdTxChS3Akfde6_g#22)**|Выпечка|**Корж (9)**|Surf (8)|Остальные (6-7)|

## РАЗДЕЛ Г: 10 готовых запросов для исследования конкретных бизнес-задач

|**Диалог**|**Точка роста**|**Результат**|**Для кого**|
|---|---|---|---|
|**[Скорость → Выручка →](https://www.perplexity.ai/search/vystupi-v-roli-konsultanta-po-DWXYrOxdTxChS3Akfde6_g#0)**|Операционная эффективность|План устранения потерь от медленного сервиса|CEO, Ops-директор|
|**[Единый стандарт →](https://www.perplexity.ai/search/vystupi-v-roli-konsultanta-po-DWXYrOxdTxChS3Akfde6_g#1)**|Стандартизация качества|Система контроля качества продукта|Технологи, R&D|
|**[Оцифровка атмосферы →](https://www.perplexity.ai/search/vystupi-v-roli-konsultanta-po-DWXYrOxdTxChS3Akfde6_g#2)**|Масштабирование атмосферы|Чеклист элементов «уюта» для новых точек|Бренд-менеджеры|
|**[От лидерства к чеку →](https://www.perplexity.ai/search/vystupi-v-roli-konsultanta-po-DWXYrOxdTxChS3Akfde6_g#3)**|Монетизация УТП|Кампании на основе восторженных отзывов|Маркетологи|
|**[Кто ваши клиенты →](https://www.perplexity.ai/search/vystupi-v-roli-konsultanta-po-DWXYrOxdTxChS3Akfde6_g#4)**|Сегментация аудитории|4 сценария потребления + персональные предложения|Стратеги|
|**[Расстановка сил →](https://www.perplexity.ai/search/vystupi-v-roli-konsultanta-po-DWXYrOxdTxChS3Akfde6_g#5)**|Конкурентное позиционирование|Карта сил и слабостей всех игроков|Аналитики|
|**[Парадокс лояльности →](https://www.perplexity.ai/search/vystupi-v-roli-konsultanta-po-DWXYrOxdTxChS3Akfde6_g#6)**|Управление лояльностью|Анализ «любящих критиков»|HR, Customer Success|
|**[Цена как стратегия →](https://www.perplexity.ai/search/vystupi-v-roli-konsultanta-po-DWXYrOxdTxChS3Akfde6_g#7)**|Гибкое ценообразование|Стратегии для разных сегментов|Финдиректор|
|**[Скрытые ниши →](https://www.perplexity.ai/search/vystupi-v-roli-konsultanta-po-DWXYrOxdTxChS3Akfde6_g#8)**|B2B-возможности|Монетизация сегмента «цифровых кочевников»|Развитие бизнеса|
|**[Масштабирование →](https://www.perplexity.ai/search/vystupi-v-roli-konsultanta-po-DWXYrOxdTxChS3Akfde6_g#9)**|Региональная экспансия|Самара как модель для других городов|Инвесторы|
